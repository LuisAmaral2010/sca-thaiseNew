...
class SolicitacaoServicoController extends Controller
{
    ...
    {
        /*
        // Cadastrar no banco de dados na tabela solicitacao_servico
        SolicitacaoServico::create([
            //'solicitacao_servico_id' =>	$request->solicitacao_servico_id,				
            'descricao' =>	$request->descricao,				
            'data_solicitacao' =>	now(), //$request->data_solicitacao,
            ...
            'created_at' =>	now(), //$request->created_at,
            'updated_at' =>	now(), //$request->update_at,
        ]);
    
        Amostra::create([
            'descricao'              => $amostra['descricao'] ?? null,
            'solicitacao_id'         => $request->solicitacao_servico_id,
        ...
        return redirect()->route('solicitacoes_servicos.index')->with('success', 'SolicitacaoServico cadastrada com sucesso!');
        */
